                ...
                <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs font-black">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="px-2 py-1 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-[11px] font-extrabold transition-colors flex items-center gap-1"
                    >
