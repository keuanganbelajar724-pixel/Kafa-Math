...
export const GameView: React.FC<GameViewProps> = ({ onLaunchMinigame }) => {
  ...
  const ALL_GAMES: GameCardItem[] = [
    ...
    },
    {
      ...
      title: 'Blok Nilai Tempat & Regrouping',
      desc: 'Manipulatif Dienes Blocks (Ratusan, Puluhan, Satuan). Tukar 10 satuan jadi 1 puluhan secara langsung tanpa ABCD!',
      category: 'cambridge_hands_on',
      icon: '🪵',
      badge: 'Dienes Blocks 🧱',
    ...
    },
    {
      ...
      title: 'Laboratorium Penggaris Geser (Ruler Lab)',
      desc: 'Geser penggaris, luruskan angka 0 cm dengan ujung benda (pensil, kunci, sendok) dan baca panjangnya!',
      category: 'cambridge_hands_on',
      icon: '📏',
      badge: 'Penggaris Geser 📐',
      color: 'from-cyan-500 to-teal-600',
    },
    {
      id: 'number_line_frog',
      title: 'Lompat Kodok Garis Bilangan (Number Line)',
      desc: 'Kendalikan lompatan kodok (+1, +2, +5, +10, -1, -5) menembus angka 10 & 20 di kolam teratai interaktif!',
      category: 'cambridge_hands_on',
      icon: '🐸',
      badge: 'Garis Bilangan 🪷',
      color: 'from-emerald-500 to-teal-600',
    },
    {
      id: 'tangram_symmetry',
      title: 'Studio Simetri Lipat & Cermin (Symmetry Lab)',
      desc: 'Sentuh kotak cermin untuk melipat & melengkapi sayap kupu-kupu, tubuh robot, istana, & hati simetris!',
      category: 'cambridge_hands_on',
      icon: '🪞',
      badge: 'Cermin Simetri 🦋',
      color: 'from-pink-500 to-rose-600',
    },
    {
      id: 'liquid_measuring_jug',
      title: 'Laboratorium Takaran & Gelas Ukur (Capacity Lab)',
      desc: 'Tuang & kuras air (mL & Liter) ke dalam gelas ukur transparan sampai meniskus tepat di garis target!',
      category: 'cambridge_hands_on',
      icon: '🧪',
      badge: 'Takaran mL & L 💧',
    ...
    {
      id: 'barchart_builder',
      title: 'Studio Diagram Batang Sentuh (Bar Chart Lab)',
      desc: 'Naikkan tinggi batang diagram dengan sentuhan agar sesuai dengan data turus (tally marks) pemilih!',
      category: 'cambridge_hands_on',
      icon: '📊',
      badge: 'Diagram Batang 📈',
      color: 'from-indigo-500 to-purple-600',
    },
    {
      id: 'pan_balance_scale',
      title: 'Neraca Aljabar & Massa Seimbang (Pan Balance)',
      desc: 'Letakkan anak timbangan (1 kg, 2 kg, 5 kg) di piring neraca sampai seimbang rata tanpa pilihan ganda!',
      category: 'cambridge_hands_on',
      icon: '⚖️',
      badge: 'Neraca Massa ⚖️',
      color: 'from-amber-500 to-yellow-600',
    },
    {
      id: 'angle_protractor_lab',
      title: 'Laboratorium Busur Derajat Sudut (Protractor Lab)',
      desc: 'Putar lengan busur derajat mengukur sudut lancip, siku-siku 90°, dan tumpul 135° dengan sentuhan presisi!',
      category: 'cambridge_hands_on',
      icon: '🧭',
      badge: 'Busur Derajat 📐',
      color: 'from-cyan-500 to-teal-600',
    },
    {
      ...
      title: 'Studio Diagram Venn & Himpunan (Venn Lab)',
      desc: 'Kelompokkan bilangan genap, kelipatan 5, dan sifat bangun ke lingkaran A, B, atau irisan tengah A ∩ B!',
      category: 'cambridge_hands_on',
      icon: '📊',
      badge: 'Diagram Venn ⭕',
    ...
    },
    {
      ...
      title: 'Studio Geoboard Karet (Area & Perimeter Lab)',
      desc: 'Regangkan karet gelang pada papan pasak geoboard untuk mengukur Luas petak dan Keliling bangun datar!',
      category: 'cambridge_hands_on',
      icon: '📐',
      badge: 'Papan Geoboard 🟩',
